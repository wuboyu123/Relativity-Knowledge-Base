...
url: https://platform.relativity.com/Server2025/Content/Managing_Relativity_dynamic_objects/RDO/Creating_and_editing_Relativity_Objects.htm
collection: developer
fetched_at: 2026-06-22T06:29:24+00:00
sha256: 027deb2201f583911be5bfc8ac8a1356c94b8bc0a845b77817dc2ed22a8f0a86
---

Creating and editing Relativity Objects Skip To Main Content Account Settings Logout
...
For information about programmatically working with RDO types, see Object Type Manager (.NET) Object Type Manager (.NET) .
...
See Security and permissions Security and permissions for more information on security.
...
- Lists Enabled - determines if the user has the ability to save a list of this object's items as a persistent list. For more information, see Lists Lists . The options are:
...
Show Link The Link button doesn't display on associative objects lists added to the layout of another object associated by a multiple or single object field to the current object type. See Adding child and associative object lists Adding child and associative object lists .

Show Unlink The Unlink button doesn't display on associative objects lists added to the layout of another object associated by a multiple or single object field to the current object type. See Adding child and associative object lists Adding child and associative object lists .
...
- Associative/Child Object - displays all child or associative objects lists for the object type. You control the button visibility for this object type. See Adding child and associative object lists Adding child and associative object lists .
...
- Custom Page URL - indicates the URL of the page after clicking Go on the mass operations bar. When you develop your mass operation, you can create your own custom page or use the Relativity custom page framework. For more information, see Customize the UI Customize the UI .
...
To display your custom mass operation handlers in this list, add them to Relativity as resource files. For more information, see Resource files and Mass Operation handlers Resource files and Mass Operation handlers in the Relativity Server 2025 Developers site.

- Select Layout - click the Select button to choose the layout that appears after the user clicks Go on the mass operations bar. You can define custom layouts for your mass operations on this object type. When you create a layout, select your new object type in the Object Type field. See Layouts Layouts . If you are adding this mass operation to an application, make sure that the layout and object type are components of this application.
