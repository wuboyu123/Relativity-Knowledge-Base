---
title: "Relativity Server APIs"
url: https://platform.relativity.com/Server2025/Content/Explore/Platform-APIs.htm
collection: developer
fetched_at: 2026-06-22T06:21:57+00:00
sha256: 720588e09a36228e3650ef690120f7fb33494b4bc55034763a6d685110aa7dae
---

Relativity Server APIs Skip To Main Content Account Settings Logout
...
For a listing of Relativity Server SDKs and APIs available for download, see this page .

## Integration APIs

The following table lists the platform Integration APIs, with links to supporting documentation. Download the OASFiles.zip for all REST OAS files.
...
- Processing Custodian Manager (.NET)
...
- Processing Data Source Manager (.NET)
...
- Processing Document Manager (.NET)
...
- Resource Server / Resource Pool (.NET)

- .NET Reference

- Package

- Resource Server / Resource Pool (REST)
...
Transfer Data Import and Export APIs Stream data into Relativity from external data sources using different transfer protocols, for example, HTTP and SMB.
...
- Relativity.Server.Kepler.SDK

- Relativity.Server,Kepler.Client.SDK

- .NET Reference (Kepler.SDK)

- .NET Reference (Kepler.Client.SDK)

- Nuget Package (Kepler.SDK)
