---
title: "Sitemap"
url: https://platform.relativity.com/Server2025/Content/Sitemap.htm
collection: developer
fetched_at: 2026-06-22T06:22:18+00:00
sha256: 9bc851e08d44a0fe0cae59c9f2ecbd6b00b9687c7ee3e1f15f881c8e924e637d
---

Sitemap Skip To Main Content Account Settings Logout
...
Targeting different nuget repositories
...
Tutorials for integrating with Relativity
...
dtSearch .NET API Reference

dtSearch Manager (REST)

dtSearch REST API Reference
...
Agent Manager .NET API Reference
...
Logging .NET API Reference

Logging Interfaces .NET API Reference
...
Object Manager .NET API Reference
...
Telemetry APM .NET API Reference

Telemetry DataContracts Shared .NET API Reference

Telemetry MetricsCollection .NET API Reference

Telemetry MetricsCollection Interfaces .NET API Reference

Telemetry Services Interfaces .NET API Reference
...
Tutorials for extending Relativity
...
Kepler Client SDK .NET API Reference
...
Relativity.Server.Agent.SDK

Relativity.Server.API.SDK

Relativity.Server.Application.SDK

Relativity.Server.ARM.SDK

Relativity.Server.Audit.SDK

Relativity.Server.CustomPages.SDK

Relativity.Server.DataTransfer.SDK

Relativity.Server.DataVisualization.SDK

Relativity.Server.DocumentViewer.SDK

Relativity.Server.DtSearch.SDK

Relativity.Server.Environment.SDK

Relativity.Server.EventHandler.SDK

Relativity.Server.Extensibility.SDK

Relativity.Server.Identity.SDK

Relativity.Server.Imaging.SDK

Relativity.Server.Import.SDK

Relativity.Server.Infrastructure.SDK

Relativity.Server.Kepler.Client.SDK

Relativity.Server.Logging.SDK

Relativity.Server.Logging.Interfaces.SDK

Relativity.Server.Notifications.SDK

Relativity.Server.OAuth2.SDK

Relativity.Server.OAuth2.Implicit.SDK

Relativity.Server.OAuth2.Interfaces.SDK

Relativity.Server.ObjectManager.SDK

Relativity.Server.ObjectModel.SDK

Relativity.Server.OutsideIn.Fi.Win32.SDK

Relativity.Server.Processing.SDK

Relativity.Server.Productions.SDK

Relativity.Server.Review.SDK

Relativity.Server.Rsapi.SDK

Relativity.Server.SDK

Relativity.Server.SearchTermsReport.SDK

Relativity.Server.Services.DataContracts.SDK

Relativity.Server.Services.Interfaces.SDK

Relativity.Server.Shared.SDK

Relativity.Server.Telemetry.APM.SDK

Relativity.Server.Telemetry.DataContracts.Shared.SDK

Relativity.Server.Telemetry.MetricsCollection.SDK

Relativity.Server.Telemetry.MetricsCollection.Interfaces.SDK

Relativity.Server.Telemetry.Services.Interfaces.SDK

Relativity.Server.Testing.Framework.SDK

Relativity.Server.Testing.Framework.Api.SDK

Relativity.Server.Transfer.SDK
