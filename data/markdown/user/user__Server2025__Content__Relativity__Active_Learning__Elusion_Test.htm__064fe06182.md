---
title: "Project Validation and Elusion Testing"
url: https://help.relativity.com/Server2025/Content/Relativity/Active_Learning/Elusion_Test.htm
collection: user
fetched_at: 2026-06-22T06:02:44+00:00
sha256: d36138a1ef3c5c7f6560fd37d4e250f3f5dc153512dd1de1548097ef32c22bf1
---

Project Validation and Elusion Testing Skip To Main Content Account Settings Logout
...
Project Validation does not check for human error. We recommend that you conduct your own quality checks to make sure reviewers are coding consistently. For more information, see Quality checks and checking for conflicts .
...
It is common practice to restrict project validation to a small set of knowledgeable reviewers. This typically includes fewer than ten reviewers.
...
When you update the rank cutoff value, the value is updated in all three places where it’s used in the application: Project Validation, Update Ranks, and Project Settings.
...
- Est. Elusion Margin of Error - the maximum difference between the sample elusion rate and the discard-pile elusion rate. Selecting a lower margin of error requires a larger sample size.

Elusion Only tests keep the margin of error that was chosen at the beginning of the test. For Elusion with Recall tests, the actual margin of error is recalculated at the end of project validation. It may be narrower than the original estimate.
...
The Release All Documents link remains on the Project Validation card after the documents have been released.
...
If you find the Project Validation results acceptable, select whether to Update ranks upon completion , and then click Complete Project to close the project. Once the project is complete, the model remains frozen. Any coding decisions that occur after Project Validation will not be used to train the (now frozen) model.

Updating ranks upon accepting Project Validation results will use the Project Validation Rank Cutoff.
