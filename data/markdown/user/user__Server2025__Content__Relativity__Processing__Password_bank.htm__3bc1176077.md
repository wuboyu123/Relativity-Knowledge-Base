---
title: "Password bank"
url: https://help.relativity.com/Server2025/Content/Relativity/Processing/Password_bank.htm
collection: user
fetched_at: 2026-06-22T06:05:47+00:00
sha256: 944caa8a690ee74b7ec1860a2953edda53dc8f99797c17b36ad3dbf852fea843
---

Password bank Skip To Main Content Account Settings Logout
...
The PDF mass action does not work with the Password Bank. Specifically, Save as PDF isn't able to connect with the password bank to grab passwords for encrypted documents. That connection is only available for native imaging and processing.
...
There is no limit on the number of passwords you can add to the password bank; however, having more than 100 passwords could degrade the performance of your processing and imaging jobs.
...
When you create a password entry and submit any job that syncs with the processing engine (imaging or processing), an entry is created in the engine for that password and that workspace. Even if you delete that password entry from the password bank, any future jobs will continue to try that password.
