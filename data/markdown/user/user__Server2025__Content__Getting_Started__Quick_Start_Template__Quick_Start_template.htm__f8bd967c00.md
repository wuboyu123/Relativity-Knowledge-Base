...
url: https://help.relativity.com/Server2025/Content/Getting_Started/Quick_Start_Template/Quick_Start_template.htm
collection: user
fetched_at: 2026-06-22T06:07:25+00:00
sha256: d76c429d387d6f70c5c6d245e3d660efa17479144338308fe522d5758f5463e8
---
...
This template isn't required to use Relativity; it's an option for logically customizing your Relativity environment and minimizing the manual effort associated with new workspace customization.
...
Component Change Date updated Release Version

Fields Added Message Event Count field and mapped to Message Count in processing June 21, 2019

Fields Added RSMF End Date field and mapped to processing June 21, 2019

Fields Added RSMF Begin Date field and mapped to processing June 21, 2019

Fields Added Deduped Count and mapped to processing June 21, 2019

Fields Image Count Field: Set Open to Associations to No April 15, 2019

Fields System modified on: Change group by and pivot to Yes April 15, 2019

Fields System modified by: Change group by and pivot to Yes April 15, 2019

Fields System created on: Change group by and pivot to Yes April 15, 2019

Fields System created by: Change group by and pivot to Yes April 15, 2019

Fields Relativity Native Timezone Offset: Change group by and pivot to Yes April 15, 2019

Fields Relativity Image Count: Change group by and pivot to Yes April 15, 2019

Fields Markup Set - Primary: Change group by and pivot to Yes April 15, 2019

Fields Batch: Change group by and pivot to Yes April 15, 2019

Fields Folder Name: Change group by and pivot to Yes April 15, 2019

Fields Has Native: Change group by and pivot to Yes April 15, 2019

Fields Has Images: Change group by and pivot to Yes April 15, 2019

Structured Analytics Name Normalization Structured Analytics Set added April 1, 2019 Blazingstar 10.1

Views Create Processing Sets view of set that need to be published January 29, 2019

Views Create view of Unprocessable files January 29, 2019

Searches Add Search Processing Errors Ready for Retry January 29, 2019

Searches Update All Processing Errors search to Processing Errors January 29, 2019

Groups Add template to group names and (do not add users) January 27, 2019

Permissions Added Processing Administrator Group and gave Processing Update permissions November 29, 2018

Group Added Processing Administrator Group November 12, 2018

Fields Change long text Email Sent Date to Sent Date. Change Date Field Sent Date/Time to Email Sent Date/Time. October 7, 2018

Scripts Remove empty script September 19, 2018

Applications Install Integration Points September 19, 2018

Searches

Remove minimum size from search from SA

This removes attachments that will not get threaded with email(s).
...
Analytics Create AL Reviews permissions group September 9, 2018

Analytics Remove mapping of Conversation ID in Analytics Profile September 9, 2018

Analytics Create Classification Index September 9, 2018

Fields New AL Designation field and choices September 9, 2018

Layouts New AL Layout September 9, 2018

Security Level 1 permissions add Folders browser, remove export to file August 21, 2018

Saved Search dtSearch index search changed to remove condition of Text Size > .01 July 1, 2018 Bluestem 9.7

Views Update email view with MSAS fields for sort June 30, 2018

Applications Install Active Learning application June 28, 2018

Searches Remove conditions from dtSearch search. June 28, 2018

Views Update 05.01 Single Recipients with MSAS field March 18, 2018

Searches Update 05.03 Inclusive emails and Family condition to be ETND::Email Thread Group is set. March 18, 2018

Searches Update Textual Near Duplicate Groups March 18, 2018

Views Update Inclusive emails and attachments view March 18, 2018

Views Update email view with MSAS fields March 18, 2018

Fields Original Email Author is now Email Original Author March 12, 2018

Fields Cleaned up keywords and notes fields February 19, 2018

Fields Production OCR Text added February 19, 2018

Tabs Move "Review Batches" tab to top level instead of under reporting February 19, 2018

Fields Changed CC (SMTP Address) to Email CC (SMTP Address) February 19, 2018

Fields Updated keywords and notes fields for all processing fields February 15, 2018

Fields Changed Sent Time to Email Sent Time February 15, 2018

Fields Change Sent Date/Time to Email Sent Date/Time February 15, 2018

Fields Changed Sender Domain to Email Sender Domain February 15, 2018

Fields Production Type with choices of Images, Images and Slipsheets, Natives, Natives and Slipsheets so that you can dictate what type of production is going to be created. February 15, 2018

Fields Added a Production Name Multiple Choice field for the purpose of marking documents for production. February 15, 2018

Searches Changed 02.06 Analytics Training Set to Not Included in Analytics February 15, 2018

SAS Created Structured Analytics sets; Email threading and Near Duplicate; Language ID; Repeated Content February 15, 2018

Folders Create Processed Data folder February 15, 2018

Processing Profile Updated Standard Profile: Change OCR Accuracy to High; Changed Deduplication to Custodial and Propagate Dedupe Data; Turn off Auto Publish; Updated destination folder to Processed Data. February 15, 2018

Searches New folder named Quick Find and popluated with the following searches. By folder, sender domain, sender name, February 15, 2018

Searches Secure admin searches folder from Level 1 and 2 permissions February 13, 2018

Fields Update batch fields with Allow Pivot and Allow Group by: Batch, Batch::Assigned To, Batch::Batch Set, Batch Status February 13, 2018

Analytics Index Index created with saved search and ready for Population after link to Repeated Content February 13, 2018

Analytics Profile Remove mapping to conversation id field February 13, 2018

Analytics Index Deleted and recreated October 18, 2017

02.07 Analytics Searchable Set Renamed to "02.07 Analytics Index" October 18, 2017

02.06 Analytics Training Set Deleted October 18, 2017

02.02 Email Threading - Emails + Attachments Changed name to "02.02 Email Threading and Near Duplicate Detection October 18, 2017

Workspace Details Workspace Name change from "Relativity Onboarding Template" to Relativity Quick Start Template" October 18, 2017

## Accessing the template file

To access the Quick Start Template file:

- Navigate to the Community and log in with your credentials.

- Select the Files tab and then select the Templates folder on the Files & Libraries page.

- Select the latest version of the quick start template from the templates list and click Download .

## Recommended pre-work

To use the template, it will be useful to understand topics covered in Admin and Processing training.

- Relativity Admin training
...
- Structured Analytics Set - use to set up and execute features such as email threading, near duplicate detection and language identification.

- Repeated Content Filters - displays the results of repeated content identification from structured analytics.

- Analytics Profiles - configure the header email field mapping for email threading.

- Analytics Indexes - create the concept index here.

- Search Indexes - create search indexes here.

- Analytics Categorization Set - create a set of example documents that Analytics uses as the basis for identifying and grouping other conceptually similar documents.
...
The Case Admin tab in the Quick Start template provides options for working with the following admin functions: Batch Sets, Markup Sets, Persistent Highlight Sets, Production Sets, and Scripts.
...
- Integration Points - use Integration Points to move documents between workplaces.

- Job History - view details about each Integration Points job.

- Job History Errors - view the errors that occurred on the Integration Points job.

- Destination Workspaces - view the details of the workspaces that were designated as destinations of an integration point.

- Integration Point Profile - view the details of all Integration Point Profiles.
