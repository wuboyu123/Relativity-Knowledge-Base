...
url: https://help.relativity.com/Server2025/Content/Relativity/Relativity_Desktop_Client/Exporting/Exporting_a_folder.htm
collection: user
fetched_at: 2026-06-22T06:14:54+00:00
sha256: 1724a6a5f11e2f7cc997e69881cb62385ef21280f3e6bd0af2dd69c549754788
---

Exporting a folder Skip To Main Content Account Settings Logout
...
When you select the Folder option, only the contents of the current folder are exported. Use Folder and Subfolders option to export the contents of both the folder and its subfolders, or the contents of an entire workspace. See Exporting a folder and its subfolders .

To export a folder:

- Open the RDC and then select a workspace.

- In the RDC browser, right-click on a specific folder, point to Export and then click Folder .

You can also highlight a folder in the RDC browser. On the Tools menu, point to Export and click Folder .) The Data Source tab in the Export Production window appears.
...
- Select a view, and click OK . Your view is listed on the Data Source tab, and determines the fields displayed in the Selected Columns box. Other settings from the file are used to populate the Destination Files tab. (You can also modify any settings on the Data Source and Destination Files tab as necessary.)
...
- On the Data Source tab, select a view in the Views box. Update the remaining options as necessary.
...
A warning message appears if you are missing information required to run the export. Update the settings for the required options, and run the export again.
