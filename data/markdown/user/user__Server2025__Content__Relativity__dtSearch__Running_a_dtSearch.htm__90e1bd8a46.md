---
title: "Running a dtSearch"
url: https://help.relativity.com/Server2025/Content/Relativity/dtSearch/Running_a_dtSearch.htm
collection: user
fetched_at: 2026-06-22T06:07:36+00:00
sha256: bebff2fec2486da687a3407ffc31f83a86805452d55e8f500f3f9b96dca93fb1
---

Running a dtSearch Skip To Main Content Account Settings Logout
...
- All characters in a dtSearch index are normalized to lowercase. Relativity does not support case-sensitive dtSearch indexes. See Case-insensitive indexes for more information.

- For example, if your exact phrase is an acronym like ACT , these will be included in the index: act , AcT , aCt , and similar.

- dtSearch combines text from multiple fields in the order they are added to the saved search. Make sure both lists of fields are ordered identically.

- The maximum number of search terms is 65,000 characters.

- Words longer than 32 characters are truncated during indexing.

- For more information, see Searching for words longer than 32 characters .
...
apple AND pear The word apple and the word pear

(apple and pear) AndAny (grape or banana) Any document that contains apple and pear , with grape and banana also being counted as hits. Grape and banana aren't evaluated as conditions; they're simply added to the search results as optional terms to be highlighted if they appear in the document.

apple OR pear Either apple or pear

apple W/5 pear Apple appears within 5 words of pear

apple PRE/5 pear Apple appears within 5 words before pear
...
apple NOT W/5 pear Apple occurs not within 5 words of pear

apple AND NOT pear Apple appears but pear does not

apple W/5 xfirstword Apple appears in the first 6 words of the document

apple w/5 xlastword Apple appears in the last 6 words of the document
...
Click the Sort by rank checkbox to sort the results by order of relevance in relation to the search terms. The most relevant documents are listed at the top of the results set, with the least relevant documents, or the documents with the smallest number of keywords, is at the end of the list.
...
Your total number of search terms cannot exceed 65,000 characters.
...
Tap on the Sort by Rank check box beneath the search box to sort the results in order of the most relevance to your search terms. The most relevant documents are listed at the top of the results set, with the least relevant documents, or the documents with the smallest number of keywords, is at the end of the list.
