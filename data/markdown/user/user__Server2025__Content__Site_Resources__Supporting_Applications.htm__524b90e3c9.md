...
url: https://help.relativity.com/Server2025/Content/Site_Resources/Supporting_Applications.htm
collection: user
fetched_at: 2026-06-22T06:03:08+00:00
sha256: 23f360ff290d19347786b8310d84e6ed220253f9987c47b559e062c10762c5bb
---
...
Relativity provides you with additional tools to customize your e-discovery platform needs from beginning to end. Follow the links below to learn more about Relativity 's supporting applications.
...
Remove documents from batch sets Removes all documents from the saved searches of all specified batch sets.
...
Date field parsing Parses the date and time from a Date field and writes each value to a separate field for each document that's returned by a specified saved search.
...
Production gap and overlap check Displays gaps or overlaps in Bates numbers for a production set.
...
Relativity App Hub The Relativity App Hub includes best-in-breed integrations and highly customized products built by Relativity developer partners and the Relativity team. You can pick and choose the solutions that best suit your unique workflows, integrating them to more easily and efficiently transfer data between software packages that serve different stages of the e-discovery process.
...
Workspace portal (Relativity Server)

In Relativity, a workspace provides a secure data repository for documents used in cases or for applications developed with Dynamic Objects. Workspace portal refers to a Relativity application that you can use to view and create workspaces across all your connected instances.
...
Collect folder path data Reports the total number and size of document files—including native, image, and production files—that are in each workspace and folder in a Relativity instance.
...
Login history by user report Displays a list of log in and log out times and session durations for users.
...
Disable inactive users Disables Relativity users who are considered inactive based on specified criteria.
