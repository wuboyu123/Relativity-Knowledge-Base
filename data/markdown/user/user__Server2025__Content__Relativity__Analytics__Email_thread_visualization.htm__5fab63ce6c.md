...
url: https://help.relativity.com/Server2025/Content/Relativity/Analytics/Email_thread_visualization.htm
collection: user
fetched_at: 2026-06-22T06:02:36+00:00
sha256: 811e17889fe40c970a75c6685df274233d1424ad0edfc590f5f4ccff099ec87a
---

Email thread visualization Skip To Main Content Account Settings Logout
...
If you are working with multiple structured analytics sets, ensure that you see the correct email thread information by opening the Display Options sub-tab inside the legend and verifying that you have the correct structured analytics set selected in the drop-down.
...
An email that has duplicate spares or non-duplicate spare emails that exist at the same location in a thread contain a double stacked email icon. These non-duplicate spare emails are grouped within an "Other Emails" section in the tooltip. The following scenarios are the most common causes of these emails not being marked as duplicate spares:
...
The tooltip window will not display for you after clicking the Enable Mass Edit Selection ( ) icon and switching to selection mode.
...
- Click to open the Display Options section of the legend, and then click on the Highlight Field switch to enable coding highlighting.

This enables the drop-down Coding Highlight field. To disable coding highlighting, click the switch again (now grayed out).

- Select the field you want to highlight in the email thread visualization pane from the drop-down Coding Highlight field (such as Confidential Designation).
