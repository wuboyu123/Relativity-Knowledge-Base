---
title: "Email threading results"
url: https://help.relativity.com/Server2025/Content/Relativity/Analytics/Email_threading_results.htm
collection: user
fetched_at: 2026-06-22T06:05:02+00:00
sha256: 958eecaaabcaaac0e3d56e7c029b8a6771d3b948543e5c82db487740559fa7dc
---

Email threading results Skip To Main Content Account Settings Logout
...
Inclusive, non-duplicate emails have black square indentation squares in the Email Threading Display field. If the emails with black indentation squares aren't actually inclusive, your extracted text format doesn't meet the formatting requirements. See Supported email header formats .
...
- On the Other tab, complete the following:
...
- On the Conditions tab, add the following condition:

- <Structured Analytics Set prefix>::Email Thread Group : is set

- On the Sort tab, sort the following fields in ascending order:
...
- Add the following search conditions with an AND operator:
